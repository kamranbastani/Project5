...
class SingleStepPathingStrategy implements PathingStrategy {
      ...
      Function<Point, Stream<Point>> potentialNeighbors)
   {
       ...
       * has been reached.
       */
      System.out.println(start + "  "+potentialNeighbors.apply(start).collect(Collectors.toList()));
      System.out.println(start + "  "+potentialNeighbors.apply(start).filter(canPassThrough).collect(Collectors.toList()));
